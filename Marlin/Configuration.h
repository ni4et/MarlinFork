...
// DHT based on Configuration.h version 010100
#define CONFIGURATION_H_VERSION 010109

// Custom variations // DHT
#define Flsun_cube // 1 extuder one hot end
//#define Flsun_cube_cyclops // 2 extruder 1 hot end
//#define Flsun_cube_chimera // 2 extruder 2 hot ends.
//#define Flsun_DIAL_GUAGE
...
#define STRING_CONFIG_H_AUTHOR "(DHT, CUBE)" // Who made the changes.
...
#if defined(Flsun_cube)
#define CUSTOM_MACHINE_NAME "Flsun_cube" // DHT
#elif defined(Flsun_cube_cyclops)
#define CUSTOM_MACHINE_NAME "Flsun_cube_cyclops" // DHT
#elif defined(Flsun_cube_chimera)
...
#define DEFAULT_NOMINAL_FILAMENT_DIA 1.75 // DHT

// For Cyclops or any "multi-extruder" that shares a single nozzle.
#if defined(Flsun_cube_cyclops)
#define SINGLENOZZLE
#endif
...
#if defined(Flsun_cube_chimera)
// These values from Configuration.h in Chimera_autolevel source
 ...
 */
#define POWER_SUPPLY 2 // I want pin high to turn on.
 ...
 */
//  DHT Installed 2208s in all 5 slots
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 400, 410 } // DHT
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1000, 1000, 4, 750  } // DHT FLSUN
 ...
 */
// DHT - Defined in FLSUN
#define Z_PROBE_SERVO_NR 0   // Defaults to SERVO 0 connector.
#define Z_SERVO_ANGLES {10,90} // DHT - per bltouch // Z Servo Deploy and Stow angles
#endif
 ...
 */
// DHT FLSUN
#if defined(Flsun_cube_chimera) // DHT
// CHIMERA
...
#elif defined(Flsun_cube_cyclops) // cyclops
...
#define XY_PROBE_SPEED 7500 // DHT
...
#define Z_MIN_PROBE_REPEATABILITY_TEST // DHT
...
// DHT - TEVO Geared extruder true
// DHT - Set back to false for installation of 2208s
...
// @section machine
// DHT - Ported to this format
// The size of the print bed
#define X_BED_SIZE 250 // This depends on where the zprobe is.
...
#define Y_MIN_POS 0
#define Z_MIN_POS 0
#define X_MAX_POS X_BED_SIZE // The probe hits the rails here
...
// DHT
  ...
  #define MIN_PROBE_X X_PROBE_OFFSET_FROM_EXTRUDER+5 //DHT
...
// Homing speeds (mm/m)
// DHT Copied values - left the comments
#define HOMING_FEEDRATE_XY (60*60)
#define HOMING_FEEDRATE_Z  (3*60) // DHT 4*60 seems too fast
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 25), (Y_MAX_POS - 10), 20 }
